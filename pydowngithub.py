...
Name,ID,Folder,Audio:  Name is the file name, ID is the youtube unique ID adn Folder is the folder to save that video
"""
parser = optparse.OptionParser(description=desc)
parser.add_option('--list', '-l',help='File that have the list of files in the github repe', dest='List', default="List.csv", action='store')
